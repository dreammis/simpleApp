...
def create_report(name,url,domain_name,nmap,robots_txt,whois):
    ...
    write_file(project_dir + '/domain_name.txt',url)
    write_file(project_dir + '/nmap.txt',url)
    write_file(project_dir + '/robots_txt.txt',url)
    write_file(project_dir + '/whois.txt',url)
