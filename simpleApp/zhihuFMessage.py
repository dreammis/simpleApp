# -*- coding: utf-8 -*-
'''
This file is a people made and due to send message to his followers.
1.Login zhihu get captchaURL,download the image
2.get followers's urls
3.sendmessage to followers
'''
...
login_data = {
    'email': 'XXXX',        # your email
    'password': 'XXXX',     # your password
    'remember_me': "true",
}

message_data = {
    'content': '亲爱的知乎用户您好～窝是一只程序猿写的爬虫程序～对打扰您表示抱歉～'
               '～如果您关注了我，我也会回关哦～',   # 你想要发送的私信
}
